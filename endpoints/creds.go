...
func (c Client) SearchCredentialsUnique(searchMap map[string]string) (UniqueCredentialList, error) {
	tempCredentialDocumentList := UniqueCredentialList{}
	morePages := true
	url := c.BaseUrl + "/credentials/search?"
	query := ""
	for key, value := range searchMap {
